...
CANONICAL_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "lighter_background": ("lighter_background", "lighter_bg", "color0", "background", "bg"),
    "foreground": ("foreground", "fg", "color7"),
    "dark_foreground": ("dark_foreground", "dark_fg", "color8", "foreground", "fg", "color7"),
    "light_foreground": ("light_foreground", "light_fg", "color7", "foreground", "fg"),
    "bright_foreground": ("bright_foreground", "bright_fg", "color15", "foreground", "fg", "color7"),
    "red": ("red", "color1"),
    "green": ("green", "color2"),
